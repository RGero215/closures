...
//write the function here
func guestlist(guestlist:[Guest]) {
...
guestlist(guestlist: invitedGuests)
/*:
...
//write the function here
func overEighteen(guestlist: [Guest]) -> [Guest]{
    var guestsOverEighteen = [Guest]()
    for guest in guestlist{
        if guest.age >= 18 {
            guestsOverEighteen.append(guest)
        }
    }
    print(guestsOverEighteen)
    return guestsOverEighteen
}
...
overEighteen(guestlist: invitedGuests)
/*:
